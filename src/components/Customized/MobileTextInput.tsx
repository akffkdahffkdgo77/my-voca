...
export default function CustomizedMobileTextInput({ theme = StyleThemes.Gray, isDisabled, count, word, definition, onChange, onClick }: CustomizedMobileTextInputType) {
    return (
