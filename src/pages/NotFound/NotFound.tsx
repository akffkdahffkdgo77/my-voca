        ...
        <div className="fixed bottom-0 left-0 right-0 top-0 z-50 min-h-screen bg-slate-50 dark:bg-slate-900">
            <div className="flex h-full flex-col items-center justify-center">
                ...
                <div className="flex gap-5">
                    ...
                    <CustomizedButton onClick={() => navigate(-1)} className="rounded border border-slate-900 p-2.5 text-slate-900 hover:opacity-70 dark:border-slate-50 dark:text-slate-50">
                        이전 페이지로 돌아가기
                    </CustomizedButton>
                </div>
            </div>
