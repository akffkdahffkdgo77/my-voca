...
export default function Add() {
    ...
    const methods = useForm<AddType>({ ...DEFAULT_VALUES, mode: 'onChange' });
            ...
            <FormProvider {...methods}>
                ...
                {fields.length > 10 && (
                    <button
                        ...
                        className="absolute right-5 bottom-5 h-[50px] w-[50px] animate-bounce rounded-full bg-black font-mono font-bold text-white"
                    >
                        TOP
                    </button>
                )}
