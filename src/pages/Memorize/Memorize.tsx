...
export default function Memorize() {
    ...
    return (
        <div className="flex w-full flex-col items-center justify-center text-slate-900 [height:calc(100vh-100px)] dark:text-slate-50">
            ...
            >
                <div className="absolute top-2.5 left-2.5 h-8 w-8 rounded-full border border-slate-900 bg-slate-900 text-center font-mono text-[14px] font-bold text-slate-50 [line-height:32px] dark:border-slate-300 dark:bg-slate-300 dark:text-slate-900">
                    {index + 1}
                </div>
                ...
                <button className="absolute right-2.5 bottom-2.5 animate-pulse text-[12px] font-bold" type="button" onClick={() => setIsWord((prev) => !prev)}>
            ...
            <div className="mt-2.5 flex w-[500px] items-center justify-end gap-x-[5px]">
                <button
                    ...
                    className="rounded-md border border-slate-900 bg-slate-50 py-[5px] px-2.5 text-[12px] font-bold text-slate-900 dark:border-slate-300 dark:bg-slate-900 dark:text-slate-50"
                >
                    이전
                </button>
                <button className="rounded-md bg-slate-900 py-[5px] px-2.5 text-[12px] font-bold text-slate-50 dark:bg-slate-500 dark:text-slate-900" type="button" onClick={() => handleClick('next')}>
                    다음
                </button>
            </div>
        </div>
