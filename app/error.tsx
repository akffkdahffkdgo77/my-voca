    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 top-0 z-50 min-h-screen bg-slate-50 dark:bg-slate-900">
            <div className="flex h-full flex-col items-center justify-center">
                ...
                <CustomizedTypography component="h2" className="mb-8 text-center text-4xl leading-10 text-slate-900 dark:text-slate-50">
                    문제가 발생하였습니다.
                    <br />
                    페이지를 새로고침 해주세요.
                </CustomizedTypography>
                <CustomizedTypography component="h3" className="mb-5 text-2xl font-bold text-slate-900 dark:text-slate-50">
                    <i>{error.message}</i>
                </CustomizedTypography>
                <CustomizedButton
                    onClick={() => reset()}
